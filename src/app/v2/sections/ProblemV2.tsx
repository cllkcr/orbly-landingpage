  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto px-4 md:px-6 text-center">
                  ...
                  return (
                    <div
                      ...
                      className={`w-9 h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 flex items-center justify-center
                        ...
                        ${
                          isOutside
                            ? "text-[var(--text-dark)]/20"
                            : "text-[var(--text-dark)]/60"
                        }`}
                    >
                      {day}
                    </div>
        ...
        >
          Research shows the brain was never built for dates and numbers. It was
          built for proximity. Everything close feels real. Everything far feels
          abstract. Your calendar shows you dates. Your brain needs distance.
        </p>
      </div>
    </section>
  );
