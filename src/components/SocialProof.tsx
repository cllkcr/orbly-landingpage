...
const TESTIMONIALS = [
  {
    quote:
      "I've tried every productivity app. They all made me feel more behind. This one actually shows me what's close.",
    name: "Jamie",
    role: "designer",
...
export default function SocialProof() {
  ...
  return (
    <section ref={sectionRef} className="py-28 md:py-40 bg-[var(--bg-dark-elevated)]">
      <div className="max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="mb-16">
          ...
          <p className="text-[var(--text-secondary)] mt-3 text-lg font-[family-name:var(--font-jetbrains)]">
            people on the waitlist and counting
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {TESTIMONIALS.map((t, i) => (
            <motion.div
              ...
              className="p-7 rounded-2xl bg-white/[0.03] border border-white/[0.06] text-left"
            >
              <div
